...
<img src="Assets/Top grossing movies (208-2024).png">
...
# 2. The Most Popular Film Genres (2018-2024)
...
<img src="Assets/Top 10 Film Genres pie chart.png">
...
# 3. Examining the Relationship Between Film Metascore Ratings and Box Office Performance
...
# 4. Film Runtime and Audience Engagement
...
According to [sources](https://gitnux.org/average-movie-length/#:~:text=average%20movie%20lengths.-,The%20Latest%20Average%20Movie%20Length%20Statistics%20Explained,derived%20from%20a%20reliable%20source), the average running time of movies typically falls between 90 minutes and 120 minutes. Films exceeding 120 minutes are generally considered to be longer movies. 
...
# 5. Examining the relationship between sequels and box office numbers
...
# 6. Correlation Between Movie Ratings and Box Office Success
...
# 7. Global Box Office: Pre, During & Post Pandemic (2018-2024)
...
## Closing thoughts
This project has been invaluable in enhancing my SQL skills and honing my ability to apply analytical thinking to numerical data, enabling me to draw correlations and conclusions. By immersing myself in the role of a data analyst for a film distribution company, I endeavored to address potential questions that a marketing manager might pose. Through this experience, I've gained practical insights into data analysis and its application in real-world scenarios, which will undoubtedly benefit me in future endeavors.